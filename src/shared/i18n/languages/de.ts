...
const de: TranslationSchema = {
  ...
  common: {
    ...
    vaultMismatchTitle: "Anderer Vault erkannt",
    vaultMismatchText:
      "Dieser Cloud-Vault gehoert zu einem anderen Vault. Die Synchronisation wurde zum Schutz deiner Daten gestoppt.",
    favorites: "Favoriten",
  ...
  login: {
    ...
    backupTitle: "Backup gefunden",
    backupDateLabel: "Backup vom:",
    backupDateUnknown: "Datum unbekannt",
    backupLoadFailed: "Backup konnte nicht geladen werden.",
  ...
  settings: {
    ...
    browserPendingEmptyTitle: "Keine offenen Anfragen",
    browserPendingEmpty: "Aktuell wartet kein Browser auf Freigabe.",
    browserPendingBadge: "Ausstehend",
    browserPairedClients: "Vertrauenswürdige Browser",
    browserPairedEmptyTitle: "Keine vertrauenswürdigen Browser",
    browserPairedEmpty:
      "Öffne die ClavisPass-Erweiterung im Browser, um Zugriff anzufragen.",
    browserPairedBadge: "Vertraut",
    browserApprove: "Browser vertrauen",
    browserReject: "Browser ablehnen",
    browserDisconnect: "Browser entfernen",
    browserRequestedAt: "Angefragt: {{value}}",
    browserApprovedAt: "Vertraut seit: {{value}}",
    browserLastSeenAt: "Zuletzt gesehen: {{value}}",
    browserUnknownClient: "Browser-Client ({{extensionId}})",
    browserUnknownVersion: "Unbekannte Version",
    browserStatusPendingTitle: "Browser-Anfrage prüfen",
    browserStatusPendingDescription:
      "Ein Browser möchte sich mit diesem Vault verbinden.",
    browserStatusReadyTitle: "Browser-Zugriff ist bereit",
    browserStatusReadyDescription:
      "Vertrauenswürdige Browser können ClavisPass nutzen, solange die Desktop-App entsperrt ist.",
  ...
  analysis: {
    ...
    searchHint: "Analyse durchsuchen",
  ...
  identities: {
    summaryTitle: "{{count}} digitale Identitäten gefunden",
    ...
    searchHint: "Identitäten durchsuchen",
    noMatches: "Keine passenden Identitäten gefunden.",
    metricIdentities: "Identitäten",
    metricAccounts: "Accounts",
    metricWebsites: "Webseiten",
    metricRisks: "Risiken",
    accountsCount: "{{count}} Accounts",
    websitesCount: "{{count}} Webseiten",
    identityUsageSummary: "{{accounts}} Accounts auf {{websites}} Webseiten",
    infoTypesCount: "{{count}} Infoarten",
    risksCount: "{{count}} Risiken",
    emailIdentity: "E-Mail-Identität",
    likelySameIdentity: "Wahrscheinlich dieselbe Identität",
    possiblyConnected: "Möglicherweise verbunden",
    ...
    insightInformation:
      "{{count}} Arten gespeicherter Informationen sind damit verknüpft.",
    insightRisks: "{{count}} verknüpfte Accounts haben Sicherheitsprobleme.",
    linkedEntries: "Verknüpfte Einträge",
    noDomain: "Keine Domain",
    noWebsites: "Für diese E-Mail sind noch keine Webseiten gespeichert.",
    entryInfoCount: "{{count}} Infoarten",
    showMore: "+{{count}} anzeigen",
