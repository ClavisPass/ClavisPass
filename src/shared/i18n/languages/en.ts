...
const en: TranslationSchema = {
  ...
  login: {
    ...
    masterPasswordWeakHint:
      "Choose a stronger master password before creating your vault.",
    masterPasswordStrongEnoughHint: "Strong enough to continue.",
    masterPasswordMismatch: "The confirmation does not match.",
    login: "Login",
  ...
  settings: {
    ...
    language: "Language",
    windowControlsStyle: "Window Buttons",
    windowControlsSystem: "System Default",
    windowControlsLeft: "macOS",
    windowControlsRight: "Classic",
    windowCornerStyle: "Window Corners",
    windowCornerRounded: "Rounded",
    windowCornerSoft: "More rounded",
    windowCornerSquare: "Square",
    ...
    browserExtensionOpenOptions: "Set up browser extensions",
  ...
  identities: {
    summaryTitle: "{{count}} digital identities found",
    summaryHint: "{{email}} appears across {{count}} accounts.",
    overviewHint:
      "{{accounts}} accounts across {{websites}} websites are linked to saved emails.",
    emptyHint: "Add emails to entries to discover identities.",
    detailMissing: "This identity is no longer available.",
    renameTitle: "Edit identity name",
    displayNamePlaceholder: "Display name, for example Private or Work",
    searchHint: "Search identities",
    noMatches: "No matching identities found.",
    metricIdentities: "Identities",
    metricAccounts: "Accounts",
    metricWebsites: "Websites",
    metricRisks: "Risks",
    accountsCount: "{{count}} accounts",
    websitesCount: "{{count}} websites",
    identityUsageSummary: "{{accounts}} accounts across {{websites}} websites",
    infoTypesCount: "{{count}} info types",
    risksCount: "{{count}} risks",
    emailIdentity: "Email identity",
    likelySameIdentity: "Likely the same identity",
    possiblyConnected: "Possibly connected",
    ...
    noDomain: "No domain",
    noWebsites: "No websites saved for this email yet.",
    entryInfoCount: "{{count}} info types",
  ...
  modules: {
    ...
    addCategoryLoginAccess: "Login & access",
    addCategoryContactIdentity: "Contact & identity",
    addCategoryPaymentDocuments: "Cards & documents",
    addCategorySecurityCodes: "Security codes",
    addCategoryNotesFiles: "Notes & files",
    addCategoryNetworkTechnical: "Network & technical",
    addCategoryCustom: "Custom fields",
    ...
    creditCardNumberInvalid: "Card number does not look plausible.",
    creditCardBrand: "Card type",
    creditCardExpiryMonth: "Month",
    creditCardExpiryYear: "Year",
    creditCardSecurityCode: "Security code",
    creditCardBank: "Bank",
    creditCardNote: "Note",
    creditCardShowMore: "Show more",
    creditCardShowLess: "Show less",
