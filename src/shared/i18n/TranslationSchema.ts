...
export type TranslationSchema = {
  ...
  settings: {
    ...
    resetSettingsText: string;
    resetSettingsAction: string;
    resetDevice: string;
    resetDeviceTitle: string;
    resetDeviceText: string;
    resetDeviceAction: string;
    clearVault: string;
    ...
    browserPairedEmptyTitle: string;
    ...
    browserUnknownVersion: string;
    browserStatusPendingTitle: string;
    browserStatusPendingDescription: string;
    browserStatusReadyTitle: string;
  ...
  modules: {
    ...
    personShowMore: string;
    personShowLess: string;
    pin: string;
    phoneNumber: string;
    task: string;
    title: string;
    ...
    noteSnippet: string;
    noteLanguage: string;
    noteLanguageText: string;
    noteLanguageJson: string;
    noteLanguageYaml: string;
    noteLanguageEnv: string;
    noteLanguageShell: string;
    noteLineNumbers: string;
    noteWrapLines: string;
    notePreview: string;
    noteShowPreview: string;
    noteHidePreview: string;
    noteEdit: string;
    noteBold: string;
    noteItalic: string;
    noteInlineCode: string;
    noteHeading: string;
    noteBulletList: string;
    noteNumberedList: string;
    noteCodeBlock: string;
    noteFormatJson: string;
  };
  moduleTemplates: {
    password: string;
    wifi: string;
